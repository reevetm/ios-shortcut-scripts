...
function buildInterface() {
	...
	let pResW=Device.screenResolution().width
  	let pResH=Device.screenResolution().height
  
	let pSizeH=Device.screenSize().height
	let pSizeW=Device.screenSize().width



let pScale=Device.screenScale()
QuickLook.present(pScale, false )
...
// new
    let sRes="Screen Res:  H: " + pResH + "  W: " + pResW

      let sSize="Screen SZ:  H: " + pSizeH + "  W: " + pSizeW

   let sScale="Screen Scale: " + pScale
...
//Point(692, 91)
	...
	context.drawText(lText, new Point(692, 139))

	context.drawText(name, new Point(527, 200))
//Point(527, 139))

// 	new stuff 
context.drawText(sRes, new Point(527, 257))

context.drawText(sSize,  new Point(527, 325))
